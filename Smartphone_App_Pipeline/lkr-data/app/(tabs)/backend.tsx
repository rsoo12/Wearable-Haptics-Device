/**
 * AWS Lambda BLE pipeline (Backend tab). The tab bar entry is hidden (`href: null` in _layout);
 * this file is kept for the cloud path. Use the **FPA** tab for on-device step/FPA processing.
 */

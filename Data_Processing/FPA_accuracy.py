...
TRIALS = [
    ('Treadmill Slow',   'outputs/TreadmillWalkingSlow1.csv',  'outputs/Trial_3_Slower_TreadillWalking_Lakshmi.csv'),
    ('Treadmill Normal', 'outputs/TreadmillWalking1.csv',      'outputs/Trial_1_Baseline_TreadmillWalking_Lakshmi.csv'),
    ('Treadmill Fast',   'outputs/TreadmillWalkingFast1.csv',  'outputs/Trial_2_Faster_TreadmillWalking_Lakshmi.csv'),
    ('Overground',       'outputs/OvergroundWalking1.csv',     'outputs/Trial_1_Baseline_OvergroundWalking_Lakshmi.csv'),
]
